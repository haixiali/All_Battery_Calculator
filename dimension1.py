...
gmsh.model.addPhysicalGroup(0, [1, 2], name="my_points1")
gmsh.model.addPhysicalGroup(0, [1], name="my_points2")
gmsh.model.addPhysicalGroup(1, [1], name="my_line")
gmsh.model.addPhysicalGroup(1, [1], name="my_line2")
